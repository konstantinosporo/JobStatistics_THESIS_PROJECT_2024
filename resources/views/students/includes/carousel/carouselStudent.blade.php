    ...
    <div class="carousel-item active">
      ...
      <div class="container ">
        <div class="carousel-caption text-start">
          <h2>@lang('messages.user_carousel.welcome')</h2>
          <p>@lang('messages.user_carousel.browse_our_db')</p>
          <p><a class="btn btn-sm btn-primary shadow" href="#">@lang('messages.user_carousel.search_for_jobs')</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="container">
        <div class="carousel-caption">
          <h2>@lang('messages.user_carousel.check_our_graphs')</h2>
          <p>@lang('messages.user_carousel.cycle_statistics')</p>
          <p><a class="btn btn-sm btn-primary shadow" href="#">@lang('messages.user_carousel.explore_graphs')</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="container shadow">
        <div class="carousel-caption text-end">
          <h2>@lang('messages.user_carousel.share_explore')</h2>
          <p>@lang('messages.user_carousel.share_view_customize')</p>
          <p><a class="btn btn-sm btn-primary shadow" href="#">@lang('messages.user_carousel.share_posts')</a></p>
        </div>
      </div>
    </div>
  </div>
