...
<div class="dropdown position-fixed bottom-0 start-0 mb-3 me-3 bd-mode-toggle">
  <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center opacity-50" id="bd-theme"
    ...
    <span class="visually-hidden" id="bd-theme-text">@lang('messages.modes.toggle')</span>
  ...
  <ul class="dropdown-menu dropdown-menu-end shadow " aria-labelledby="bd-theme-text">
    <li>
      <button type="button" class="dropdown-item d-flex align-items-center " data-bs-theme-value="light"
        ...
        @lang('messages.modes.lightMode')
        <svg class="bi ms-1 checkmark d-none" width="1em" height="1em">
          <use href="#check2"></use>
        </svg>
      </button>
    </li>
