    ...
    <div class="col-lg-8 col-md-7 col-10">
      ...
      @if (session('error'))
        <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          <strong><i class="bi bi-x-circle me-1"></i></strong> @lang('messages.user.sign_in_error')
        </div>
      @endif
          ...
          <div class="col-lg-6">
            <div class="card-body p-4 p-lg-5">
              ...
              <form action="" method="post">
                ...
                <div class="mb-3">
                  <input type="email" placeholder="@lang('messages.form_fields.email')" name="email" class="form-control shadow-sm"
                    value="{{ session('user') ? $user->email : '' }}">

                </div>
                <div class="mb-3">
                  <input type="password" placeholder="@lang('messages.form_fields.password')" name="password" class="form-control shadow-sm">
                </div>
                ...
                @if (session('alert'))
                  <div class="alert text-muted alert-danger alert-dismissible fade show" role="alert">
                ...
                <div class="container text-center">
                  <button type="submit" class="btn btn-primary mt-3 shadow">@lang('messages.buttons.sign_in')</button>
                </div>
              </form>
